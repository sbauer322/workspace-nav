...
lt.object.tags__GT_behaviors.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"sidebar.workspace","sidebar.workspace",3781278709),null], null), null));
...
lt.plugins.workspace_nav.__BEH__on_clicked_select = (function __BEH__on_clicked_select(tree_item){return lt.plugins.workspace_nav.select_new_sibling.call(null,(function (_){return tree_item;
}));
});
...
lt.plugins.workspace_nav.children = (function children(parent){return cljs.core.concat.call(null,cljs.core.sort_by.call(null,(function (p1__8311_SHARP_){return clojure.string.lower_case.call(null,lt.objs.files.basename.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,p1__8311_SHARP_))));
}),new cljs.core.Keyword(null,"folders","folders",4625622327).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,parent))),cljs.core.sort_by.call(null,(function (p1__8312_SHARP_){return clojure.string.lower_case.call(null,lt.objs.files.basename.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,p1__8312_SHARP_))));
}),new cljs.core.Keyword(null,"files","files",1111338473).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,parent))));
});
lt.plugins.workspace_nav.parent = (function parent(tree_item){var or__6743__auto__ = lt.objs.sidebar.workspace.find_by_path.call(null,lt.objs.files.parent.call(null,new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,tree_item))));if(cljs.core.truth_(or__6743__auto__))
...
lt.plugins.workspace_nav.prev_sibling = (function prev_sibling(tree_item){return cljs.core.last.call(null,cljs.core.take_while.call(null,(function (p1__8313_SHARP_){return !(cljs.core._EQ_.call(null,tree_item,p1__8313_SHARP_));
}),lt.plugins.workspace_nav.siblings.call(null,tree_item)));
});
lt.plugins.workspace_nav.next_sibling = (function next_sibling(tree_item){return cljs.core.first.call(null,cljs.core.rest.call(null,cljs.core.drop_while.call(null,(function (p1__8314_SHARP_){return !(cljs.core._EQ_.call(null,tree_item,p1__8314_SHARP_));
}),lt.plugins.workspace_nav.siblings.call(null,tree_item))));
});
...
{var or__6743__auto__ = lt.plugins.workspace_nav.next_sibling.call(null,tree_item);if(cljs.core.truth_(or__6743__auto__))
{return or__6743__auto__;
} else
{{
var G__8315 = lt.plugins.workspace_nav.parent.call(null,tree_item);
tree_item = G__8315;
continue;
}
}
...
{var or__6743__auto__ = cljs.core.first.call(null,lt.plugins.workspace_nav.children.call(null,tree_item));if(cljs.core.truth_(or__6743__auto__))
{return or__6743__auto__;
} else
...
{{
var G__8316 = cljs.core.last.call(null,lt.plugins.workspace_nav.children.call(null,tree_item));
tree_item = G__8316;
continue;
}
} else
...
lt.plugins.workspace_nav.scroll_to_tree_item = (function scroll_to_tree_item(tree_item){var workspace_container = lt.util.dom.$.call(null,new cljs.core.Keyword(null,"ul.root","ul.root",615589195),lt.object.__GT_content.call(null,lt.objs.sidebar.workspace.sidebar_workspace));goog.style.scrollIntoContainerView(lt.util.dom.$.call(null,new cljs.core.Keyword(null,"p","p",1013904354),lt.object.__GT_content.call(null,tree_item)),lt.util.dom.$.call(null,new cljs.core.Keyword(null,"ul.root","ul.root",615589195),lt.object.__GT_content.call(null,lt.objs.sidebar.workspace.sidebar_workspace)));
return (workspace_container["scrollLeft"] = 0);
});
lt.plugins.workspace_nav.select_new_sibling = (function select_new_sibling(sibling_finder){return lt.object.update_BANG_.call(null,lt.objs.sidebar.workspace.sidebar_workspace,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("lt.plugins.workspace-nav","selected","lt.plugins.workspace-nav/selected",1110619727)], null),(function (selected){var temp__4090__auto__ = sibling_finder.call(null,selected);if(cljs.core.truth_(temp__4090__auto__))
{var new_selection = temp__4090__auto__;lt.plugins.workspace_nav.set_selected_class.call(null,selected,"");
...
{lt.object.raise.call(null,lt.plugins.workspace_nav.parent.call(null,lt.plugins.workspace_nav.selected_tree.call(null)),new cljs.core.Keyword(null,"close!","close!",3951350939));
return lt.plugins.workspace_nav.select_new_sibling.call(null,lt.plugins.workspace_nav.parent);
}
})], null));
}
